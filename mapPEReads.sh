...
if [ "$GENOME" == "mm9" ]; then
    if [ ! -z "$REPENRICH" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/Ensembl/NCBIM37/Bowtie2IndexWithAbundance/bowtie/Bowtie2IndexWithAbundance"
    elif [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm9/STAR/"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm9/kallisto/Mus_musculus.NCBIM37.67.cdna.all.idx"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm9/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "mm10" ]; then
    if [ ! -z "$REPENRICH" ]; then
        GENOMEINDEX=""
    elif [ ! -z "$BWA" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm10/bwa/mm10.fa"
    elif [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm10/STAR/"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm10/kallisto/Mus_musculus.GRCm38.cdna.all.idx"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Mus_musculus/mm10/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg19" ]; then
    if [ ! -z "$REPENRICH" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/Ensembl/GRCh37/Bowtie2IndexInklAbundant/bowtie/genome_and_Abundant"
    elif [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg19/STAR/"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg19/kallisto/Homo_sapiens.GRCh37.cdna.all.idx"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg19/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg38" ]; then
    if [ ! -z "$REPENRICH" ]; then
        GENOMEINDEX=""
    elif [ ! -z "$BWA" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg38/bwa/hg38.fa.chr"
    elif [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg38/STAR/"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg38/kallisto/Homo_sapiens.GRCh38.cdna.all.idx"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/hg38/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg19_ifn" ]; then
    GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Homo_sapiens/interferon_genes/interferon"
elif [ "$GENOME" == "dm6" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Dro_melanogaster/dm6/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Dro_melanogaster/dm6/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/Dro_melanogaster/dm6/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "ERCC" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ERCC/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ERCC/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ERCC/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg19_dm6" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_dm6/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_dm6/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_dm6/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "mm9_dm6" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm9_dm6/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm9_dm6/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm9_dm6/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "mm10_dm6" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_dm6/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_dm6/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_dm6/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "mm10_ecoli" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_ecoli/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_ecoli/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/mm10_ecoli/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg19_mm9" -o "$GENOME" == "mm9_hg19" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_mm9/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_mm9/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg19_mm9/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "hg38_mm10" -o "$GENOME" == "mm10_hg38" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg38_mm10/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg38_mm10/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/hg38_mm10/bowtie2/Bowtie2IndexWithAbundance"
    fi  
elif [ "$GENOME" == "ce11_dm6" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_dm6/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_dm6/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_dm6/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "ce11_mm10" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_mm10/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_mm10/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ce11_mm10/bowtie2/Bowtie2IndexWithAbundance"
    fi
elif [ "$GENOME" == "ecoli" ]; then
    if [ ! -z "$STAR" -o ! -z "$STAR_SINGLE" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ecoli/STAR"
    elif [ ! -z "$KALLISTO" ]; then
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ecoli/kallisto/"
    else
        GENOMEINDEX="/home/xfd783/data/13_ALL_ANNOTATIONS/assemblies/spikeIn/ecoli/bowtie2/Bowtie2IndexWithAbundance"
    fi  
elif [ -d "${GENOME}" ]; then
    GENOMEINDEX=${GENOME}
else
...
if [ ! -z "$STAR_SINGLE" ]; then
    ...
    if [ -z "$BAMTOBW" ]; then
        ...
        # ls *.sort | parallel -j 1 'bedGraphToBigWig {} /home/xfd783/data/13_ALL_ANNOTATIONS/annotations/SIZE/mouse.mm9.genome bigWig/{.}.bw' &
        if [ ! -z "$UNIQUE" ]; then
